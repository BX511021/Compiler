...
public class Block {
    ...
    public void setFuncHead(SymbolItem funcHead) {
        if (this.funcHead != null) {
            ErrorType.warning("You are changing the func head of an existing Block\'s func head!");
        }
        if (!type.equals(BlockType.FUNC_BLOCK)) {
            ErrorType.warning("You are setting a func head of an none-func block!");
        }
...
//                Logger.GetLogger().SymbolLog(line.toString());
                Symbolpart.SymbolLog(line.toString());
